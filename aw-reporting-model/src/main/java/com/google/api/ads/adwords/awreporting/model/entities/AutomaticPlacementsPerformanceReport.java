...
/**
   * Specific report class for AutomaticPlacementsPerformanceReport.
 *
*/
@Entity
@Table(name = "AW_AutomaticPlacementsPerformanceReport")
@CsvReport(value = ReportDefinitionReportType.AUTOMATIC_PLACEMENTS_PERFORMANCE_REPORT)
public class AutomaticPlacementsPerformanceReport extends DateReport {
  ...
  @CsvField(value = "URL", reportField = "CriteriaParameters")
   ...
   */
  public AutomaticPlacementsPerformanceReport() {
  }

  public AutomaticPlacementsPerformanceReport(Long topAccountId, Long accountId){
  ...
  public boolean equals(Object obj) {
    ...
    AutomaticPlacementsPerformanceReport other = (AutomaticPlacementsPerformanceReport) obj;
