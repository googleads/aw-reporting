...
/**
 * Specific report class for ReportGender
 */
@Entity
@com.googlecode.objectify.annotation.Entity
@Table(name = "AW_ReportGender")
@CsvReport(value = ReportDefinitionReportType.GENDER_PERFORMANCE_REPORT)
public class ReportGender extends ReportBase {
  ...
  public ReportGender(Long topAccountId, Long accountId) {
