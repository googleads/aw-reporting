...
/**
   * Specific report class for SearchQueryPerformanceReport.
 *
*/
@Entity
@Table(name = "AW_SearchQueryPerformanceReport")
@CsvReport(value = ReportDefinitionReportType.SEARCH_QUERY_PERFORMANCE_REPORT)
public class SearchQueryPerformanceReport extends DateReport { 
   ...
   */
  public SearchQueryPerformanceReport() {
  }

  public SearchQueryPerformanceReport(Long topAccountId, Long accountId){
  ...
  public void setRowId() {
    ...
    if (!StringUtils.isEmpty(query)) {
      idBuilder.append("-").append(StringsUtil.calculateHash(query));
    }
    ...
    if (!StringUtils.isEmpty(queryMatchTypeWithVariant)) {
      idBuilder.append("-").append(queryMatchTypeWithVariant);
    }
  ...
  public boolean equals(Object obj) {
    ...
    SearchQueryPerformanceReport other = (SearchQueryPerformanceReport) obj;
    return new EqualsBuilder()
      ...
      .append(destinationUrl, other.destinationUrl)
      ...
      .append(finalUrl, other.finalUrl)
