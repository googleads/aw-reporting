...
/**
   * Specific report class for FinalUrlReport.
 *
*/
@Entity
@Table(name = "AW_FinalUrlReport")
@CsvReport(value = ReportDefinitionReportType.FINAL_URL_REPORT)
public class FinalUrlReport extends DateReport { 
   ...
   */
  public FinalUrlReport() {
  }

  public FinalUrlReport(Long topAccountId, Long accountId){
  ...
  public String getEffectiveTrackingUrlTemplate() {
    return effectiveTrackingUrlTemplate;
  }

  public void setEffectiveTrackingUrlTemplate(String effectiveTrackingUrlTemplate) {
    this.effectiveTrackingUrlTemplate = effectiveTrackingUrlTemplate;
  }
  ...
  public void setRowId() {
    ...
    if (!StringUtils.isEmpty(criteriaParameters)) {
      idBuilder.append("-").append(criteriaParameters);
    }
    if (!StringUtils.isEmpty(effectiveFinalUrl)) {
      idBuilder.append("-").append(StringsUtil.calculateHash(effectiveFinalUrl));
    }
  ...
  public boolean equals(Object obj) {
    ...
    FinalUrlReport other = (FinalUrlReport) obj;
    return new EqualsBuilder()
      ...
      .append(effectiveFinalUrl, other.effectiveFinalUrl)
      .append(effectiveTrackingUrlTemplate, other.effectiveTrackingUrlTemplate)
  ...
  public int hashCode() {
    return new HashCodeBuilder(17, 37)
      ...
      .append(device)
      .append(effectiveFinalUrl)
      .append(effectiveTrackingUrlTemplate)
