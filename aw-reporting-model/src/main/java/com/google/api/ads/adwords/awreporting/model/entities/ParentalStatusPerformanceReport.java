...
/**
   * Specific report class for ParentalStatusPerformanceReport.
 *
*/
@Entity
@Table(name = "AW_ParentalStatusPerformanceReport")
@CsvReport(value = ReportDefinitionReportType.PARENTAL_STATUS_PERFORMANCE_REPORT)
public class ParentalStatusPerformanceReport extends DateReport {
   ...
   */
  public ParentalStatusPerformanceReport() {
  }

  public ParentalStatusPerformanceReport(Long topAccountId, Long accountId){
  ...
  public boolean equals(Object obj) {
    ...
    ParentalStatusPerformanceReport other = (ParentalStatusPerformanceReport) obj;
