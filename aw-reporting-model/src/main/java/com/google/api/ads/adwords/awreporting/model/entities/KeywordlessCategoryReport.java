...
/**
   * Specific report class for KeywordlessCategoryReport.
 *
*/
@Entity
@Table(name = "AW_KeywordlessCategoryReport")
@CsvReport(value = ReportDefinitionReportType.KEYWORDLESS_CATEGORY_REPORT)
public class KeywordlessCategoryReport extends DateReport {
  ...
  @Column(name = "Category0")
  @CsvField(value = "Top level categories", reportField = "Category0")
  private String category0;

  @Column(name = "Category1")
  @CsvField(value = "First level sub-categories", reportField = "Category1")
  private String category1;

  @Column(name = "Category2")
  @CsvField(value = "Second level sub-categories", reportField = "Category2")
   ...
   */
  public KeywordlessCategoryReport() {
  }

  public KeywordlessCategoryReport(Long topAccountId, Long accountId){
  ...
  public boolean equals(Object obj) {
    ...
    KeywordlessCategoryReport other = (KeywordlessCategoryReport) obj;
    return new EqualsBuilder()
      ...
      .append(category0, other.category0)
      .append(category1, other.category1)
      .append(category2, other.category2)
