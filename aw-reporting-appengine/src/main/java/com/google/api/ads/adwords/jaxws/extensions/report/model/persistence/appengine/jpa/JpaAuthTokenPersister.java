 ...
 */
@Component
public class JpaAuthTokenPersister implements AuthTokenPersister {

  private EntityPersister jpaEntityPersister;
   ...
   */
  @Autowired
  public JpaAuthTokenPersister(
      @Qualifier("jpaEntityPersister") EntityPersister jpaEntityPersister) {
    this.jpaEntityPersister = jpaEntityPersister;
  }
  ...
  public void persistAuthToken(AuthMcc authToken) {
    jpaEntityPersister.save(authToken);
  }
  ...
  public AuthMcc getAuthToken(String mccAccountId) {
    List<AuthMcc> list = jpaEntityPersister.get(AuthMcc.class, "topAccountId", mccAccountId);
