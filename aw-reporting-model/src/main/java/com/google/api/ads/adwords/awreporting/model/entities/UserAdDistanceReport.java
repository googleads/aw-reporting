...
/**
   * Specific report class for UserAdDistanceReport.
 *
*/
@Entity
@Table(name = "AW_UserAdDistanceReport")
@CsvReport(value = ReportDefinitionReportType.USER_AD_DISTANCE_REPORT)
public class UserAdDistanceReport extends DateReport {
  ...
  @Column(name = "DistanceBucket")
  @CsvField(value = "Distance from location extensions", reportField = "DistanceBucket")
   ...
   */
  public UserAdDistanceReport() {
  }

  public UserAdDistanceReport(Long topAccountId, Long accountId){
  ...
  public void setDistanceBucket(String distanceBucket) {
  ...
  public void setRowId() {
    ...
    if (!StringUtils.isEmpty(distanceBucket)) {
      idBuilder.append("-").append(distanceBucket);
    }
  ...
  public boolean equals(Object obj) {
    ...
    UserAdDistanceReport other = (UserAdDistanceReport) obj;
