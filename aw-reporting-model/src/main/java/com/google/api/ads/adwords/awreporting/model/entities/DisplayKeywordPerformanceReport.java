...
/**
   * Specific report class for DisplayKeywordPerformanceReport.
 *
*/
@Entity
@Table(name = "AW_DisplayKeywordPerformanceReport")
@CsvReport(value = ReportDefinitionReportType.DISPLAY_KEYWORD_PERFORMANCE_REPORT)
public class DisplayKeywordPerformanceReport extends DateReport {
   ...
   */
  public DisplayKeywordPerformanceReport() {
  }

  public DisplayKeywordPerformanceReport(Long topAccountId, Long accountId){
  ...
  public boolean equals(Object obj) {
    ...
    DisplayKeywordPerformanceReport other = (DisplayKeywordPerformanceReport) obj;
