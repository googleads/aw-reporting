...
/**
   * Specific report class for DestinationUrlReport.
 *
*/
@Entity
@Table(name = "AW_DestinationUrlReport")
@CsvReport(value = ReportDefinitionReportType.DESTINATION_URL_REPORT)
public class DestinationUrlReport extends DateReport { 
   ...
   */
  public DestinationUrlReport() {
  }

  public DestinationUrlReport(Long topAccountId, Long accountId){
  ...
  public void setRowId() {
    ...
    if (!StringUtils.isEmpty(effectiveDestinationUrl)) {
      idBuilder.append("-").append(StringsUtil.calculateHash(effectiveDestinationUrl));
    }
  ...
  public boolean equals(Object obj) {
    ...
    DestinationUrlReport other = (DestinationUrlReport) obj;
    return new EqualsBuilder()
      ...
      .append(criteriaStatus, other.criteriaStatus)
      ...
      .append(effectiveDestinationUrl, other.effectiveDestinationUrl)
  ...
  public int hashCode() {
    return new HashCodeBuilder(17, 37)
      ...
      .append(device)
      .append(effectiveDestinationUrl)
