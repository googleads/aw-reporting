...
/**
   * Specific report class for GenderPerformanceReport.
 *
*/
@Entity
@Table(name = "AW_GenderPerformanceReport")
@CsvReport(value = ReportDefinitionReportType.GENDER_PERFORMANCE_REPORT)
public class GenderPerformanceReport extends DateReport {
  ...
  @CsvField(value = "Gender", reportField = "Criteria")
  ...
  @Column(name = "Status")
  @CsvField(value = "Gender state", reportField = "Status")
   ...
   */
  public GenderPerformanceReport() {
  }

  public GenderPerformanceReport(Long topAccountId, Long accountId){
  ...
  public boolean equals(Object obj) {
    ...
    GenderPerformanceReport other = (GenderPerformanceReport) obj;
