...
/**
   * Specific report class for CampaignNegativePlacementsPerformanceReport.
 *
*/
@Entity
@Table(name = "AW_CampaignNegativePlacementsPerformanceReport")
@CsvReport(value = ReportDefinitionReportType.CAMPAIGN_NEGATIVE_PLACEMENTS_PERFORMANCE_REPORT)
public class CampaignNegativePlacementsPerformanceReport extends Report {
  ...
  @CsvField(value = "Exclusion", reportField = "Criteria")
   ...
   */
  public CampaignNegativePlacementsPerformanceReport() {
  }

  public CampaignNegativePlacementsPerformanceReport(Long topAccountId, Long accountId){
  ...
  public boolean equals(Object obj) {
    ...
    CampaignNegativePlacementsPerformanceReport other = (CampaignNegativePlacementsPerformanceReport) obj;
