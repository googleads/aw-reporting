...
/**
   * Specific report class for CampaignLocationTargetReport.
 *
*/
@Entity
@Table(name = "AW_CampaignLocationTargetReport")
@CsvReport(value = ReportDefinitionReportType.CAMPAIGN_LOCATION_TARGET_REPORT)
public class CampaignLocationTargetReport extends DateReport {
   ...
   */
  public CampaignLocationTargetReport() {
  }

  public CampaignLocationTargetReport(Long topAccountId, Long accountId){
  ...
  public boolean equals(Object obj) {
    ...
    CampaignLocationTargetReport other = (CampaignLocationTargetReport) obj;
