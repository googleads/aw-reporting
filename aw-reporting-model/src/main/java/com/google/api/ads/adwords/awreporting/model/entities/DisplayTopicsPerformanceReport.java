...
/**
   * Specific report class for DisplayTopicsPerformanceReport.
 *
*/
@Entity
@Table(name = "AW_DisplayTopicsPerformanceReport")
@CsvReport(value = ReportDefinitionReportType.DISPLAY_TOPICS_PERFORMANCE_REPORT)
public class DisplayTopicsPerformanceReport extends DateReport {
  ...
  @CsvField(value = "Topic", reportField = "Criteria")
   ...
   */
  public DisplayTopicsPerformanceReport() {
  }

  public DisplayTopicsPerformanceReport(Long topAccountId, Long accountId){
  ...
  public boolean equals(Object obj) {
    ...
    DisplayTopicsPerformanceReport other = (DisplayTopicsPerformanceReport) obj;
