...
/**
   * Specific report class for AdCustomizersFeedItemReport.
 *
*/
@Entity
@Table(name = "AW_AdCustomizersFeedItemReport")
@CsvReport(value = ReportDefinitionReportType.AD_CUSTOMIZERS_FEED_ITEM_REPORT)
public class AdCustomizersFeedItemReport extends DateReport {
  ...
  @Column(name = "FeedItemAttributes")
  @CsvField(value = "Attribute Values", reportField = "FeedItemAttributes")
  private String feedItemAttributes;

  @Column(name = "FeedItemEndTime")
  @CsvField(value = "End date", reportField = "FeedItemEndTime")
  private Long feedItemEndTime;

  @Column(name = "FeedItemId")
  @CsvField(value = "Item ID", reportField = "FeedItemId")
  private Long feedItemId;

  @Column(name = "FeedItemStartTime")
  @CsvField(value = "Start date", reportField = "FeedItemStartTime")
  private Long feedItemStartTime;

  @Column(name = "FeedItemStatus")
  @CsvField(value = "Item state", reportField = "FeedItemStatus")
   ...
   */
  public AdCustomizersFeedItemReport() {
  }

  public AdCustomizersFeedItemReport(Long topAccountId, Long accountId){
  ...
  public String getFeedItemAttributes() {
    return feedItemAttributes;
  }

  public void setFeedItemAttributes(String feedItemAttributes) {
    this.feedItemAttributes = feedItemAttributes;
  }

  public Long getFeedItemEndTime() {
    return feedItemEndTime;
  }

  public void setFeedItemEndTime(Long feedItemEndTime) {
    this.feedItemEndTime = feedItemEndTime;
  }
  ...
  public Long getFeedItemStartTime() {
    return feedItemStartTime;
  }

  public void setFeedItemStartTime(Long feedItemStartTime) {
    this.feedItemStartTime = feedItemStartTime;
  }

  public String getFeedItemStatus() {
    return feedItemStatus;
  }

  public void setFeedItemStatus(String feedItemStatus) {
  ...
  public boolean equals(Object obj) {
    ...
    AdCustomizersFeedItemReport other = (AdCustomizersFeedItemReport) obj;
    return new EqualsBuilder()
      ...
      .append(feedItemAttributes, other.feedItemAttributes)
      .append(feedItemEndTime, other.feedItemEndTime)
      .append(feedItemId, other.feedItemId)
      .append(feedItemStartTime, other.feedItemStartTime)
      .append(feedItemStatus, other.feedItemStatus)
  ...
  public int hashCode() {
    return new HashCodeBuilder(17, 37)
      ...
      .append(feedId)
      .append(feedItemAttributes)
      .append(feedItemEndTime)
      .append(feedItemId)
      .append(feedItemStartTime)
      .append(feedItemStatus)
